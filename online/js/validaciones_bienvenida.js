		...
		function () {
			...
			form2.addEventListener(
				...
				(e) => {
					...
					if (telefono1 == '' || codigoPais1 == '' || codigoPais1 == '') {
						mensaje(e, 'telefonoDiv', 'block', 'Ingrese su teléfono');
					} else if (telefonoValidar(telefono1) === false) {
						mensaje(e, 'telefonoDiv', 'block', 'Ingrese un teléfono válido');
					} else {
						let caja = document.getElementById(`telefonoDiv`);
						caja.style.display = '';
					}
					...
					if (email2 == '') {
						...
						mensaje(e, 'emailDiv2', 'block', 'Ingrese un correo válido');
					} else {
			...
			form3.addEventListener(
				...
				(e) => {
					...
					if (email3 == '') {
						...
						mensaje(e, 'emailDiv3', 'block', 'Ingrese un correo válido');
					} else {
...
function telefonoValidar(texto) {
	const telefonoExpresion = /^([0-9]{10,11})$/;
